...
import { removeEventEditData } from '@app/state/event-edit/event-edit.actions';
  ...
  public constructor() {
    this.router.events
      ...
      .subscribe((event: NavigationEnd) => {
        ...
        if (!destination.includes('user/event/update-event')) {
          this.store.dispatch(removeEventEditData());
        }
      });
  }
